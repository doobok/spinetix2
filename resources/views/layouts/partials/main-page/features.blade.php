            ...
            <div v-animate="'zz-l'" class="w-full sm:w-2/3 lg:w-1/3">
                <div class="single-services">
                    ...
                    <div class="mt-8 services-content">
                        ...
                        <a class="duration-300 hover:text-theme-color" v-scroll-to="'#simple'" href="#">{{__('site.read-more')}}</a>
                    </div>
                </div>
            </div>
            <div v-animate="'zz-up'" class="w-full sm:w-2/3 lg:w-1/3">
                <div class="mt-8 text-center single-services">
                    ...
                    <div class="mt-8 services-content">
                        ...
                        <a class="duration-300 hover:text-theme-color" v-scroll-to="'#universalism'" href="#">{{__('site.read-more')}}</a>
                    </div>
                </div>
            </div>
            <div v-animate="'zz-r'" class="w-full sm:w-2/3 lg:w-1/3">
                <div class="mt-8 text-center single-services">
                    ...
                    <div class="mt-8 services-content">
                        ...
                        <a class="duration-300 hover:text-theme-color" v-scroll-to="'#reliability'" href="#">{{__('site.read-more')}}</a>
                    </div>
                </div>
            </div>
        </div>
