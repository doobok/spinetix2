<template>
    <button class="fixed right-0 bottom-0 bg-white mr-4 mb-16 p-2 opacity-70 rounded z-20" @click="toggleTheme" :title="$ml.get('dark_mode_toggle')">
        <svg xmlns="http://www.w3.org/2000/svg" class="text-yellow-800" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
